<nav x-data="menuMobile()" class="flex items-center justify-between flex-wrap py-6">
    ...
    <div class="block xl:hidden">
        <button x-spread="trigger" class="flex items-center px-3 py-2 border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white">
    ...
    <div x-spread="dialogue" class="w-full xl:block flex-grow xl:flex xl:items-center xl:w-auto">
        <ul class="text-sm xl:flex-grow">
            ...
            <li x-data="dropdown()" class="block mt-4 xl:inline-block xl:mt-0 xl:mr-4 mr-0 relative">
                ...
                <ul x-spread="show" class="dropdown-menu {!! isset($menu['dropdown']['class']) && $menu['dropdown']['class'] ? $menu['dropdown']['class'] : 'bg-white'!!} xl:absolute lg:relative md:relative sm:relative relative xl:w-auto lg:w-full md:w-full sm:w-full w-full xl:float-left float-none">
